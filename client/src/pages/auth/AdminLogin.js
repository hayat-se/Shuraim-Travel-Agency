    ...
    <div className="auth-container" style={{ position: 'relative' }}>
      ...
      <Link
        ...
        style={{
          ...
          fontWeight: 700,
          fontSize: '1.1rem',
          boxShadow: '0 4px 16px 0 #0072ff1f',
      ...
      >
        <svg width="20" height="20" viewBox="0 0 28 17.5" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
